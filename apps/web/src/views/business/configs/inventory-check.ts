...
export const inventoryCheckConfig: BusinessDocumentConfig = {
  ...
  columns: [
    ...
    { prop: 'goodsCount', label: '商品数', minWidth: 80, kind: 'number' },
    { prop: 'allQty', label: '全部数量', minWidth: 95, kind: 'number' },
    { prop: 'lessQty', label: '盘亏', minWidth: 80, kind: 'number' },
    { prop: 'overflowQty', label: '盘盈', minWidth: 80, kind: 'number' },
    { prop: 'progressPct', label: '处理进度', minWidth: 130, kind: 'progress' },
    { prop: 'completedDocumentCount', label: '已生成单据', minWidth: 100, kind: 'number' },
