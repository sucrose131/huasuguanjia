...
export const salesOrderConfig: BusinessDocumentConfig = {
  ...
  columns: [
    ...
    { prop: 'quantity', label: '订单数量', minWidth: 105, kind: 'number' },
    { prop: 'orderAmount', label: '订单金额', minWidth: 110, kind: 'money' },
    { prop: 'amount', label: '实际金额', minWidth: 110, kind: 'money' },
    { prop: 'receivedAmount', label: '累计收款', minWidth: 110, kind: 'money' },
    { prop: 'refundedAmount', label: '累计退款', minWidth: 110, kind: 'money' },
    { prop: 'netAmount', label: '净收款', minWidth: 110, kind: 'money' },
